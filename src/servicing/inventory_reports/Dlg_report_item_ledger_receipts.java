 ...
 * @author Guinness
 */
public class Dlg_report_item_ledger_receipts extends javax.swing.JDialog {

    /**
     * Creates new form Dlg_report_item_ledger_receipts
     */
...
//</editor-fold>
    ...
    private Dlg_report_item_ledger_receipts(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        setUndecorated(true);
        initComponents();
        myInit();
    ...
    private Dlg_report_item_ledger_receipts(java.awt.Dialog parent, boolean modal) {
        super(parent, modal);
        setUndecorated(true);
        initComponents();
        myInit();
    ...
    public Dlg_report_item_ledger_receipts() {
        super();
        setUndecorated(true);
        initComponents();
        myInit();
    ...
    private Dlg_report_item_ledger_receipts myRef;

    private void setThisRef(Dlg_report_item_ledger_receipts myRef) {
        this.myRef = myRef;
    }
    private static java.util.Map<Object, Dlg_report_item_ledger_receipts> dialogContainer = new java.util.HashMap();
    ...
    public static Dlg_report_item_ledger_receipts create(java.awt.Window parent, boolean modal) {
    ...
    public static Dlg_report_item_ledger_receipts create(java.awt.Window parent, java.awt.Dialog.ModalityType modalType) {

        if (parent instanceof java.awt.Frame) {

            Dlg_report_item_ledger_receipts dialog = dialogContainer.get(parent);

            if (dialog == null) {
                dialog = new Dlg_report_item_ledger_receipts((java.awt.Frame) parent, false);
        ...
        if (parent instanceof java.awt.Dialog) {
            ...
            if (dialog == null) {
                dialog = new Dlg_report_item_ledger_receipts((java.awt.Dialog) parent, false);
                dialog.setModalityType(modalType);
                dialogContainer.put(parent, dialog);
                java.util.logging.Logger.getAnonymousLogger().log(Level.INFO, "instances: {0}", dialogContainer.size());
                dialog.setThisRef(dialog);
    ...
    public static void main(String args[]) {
        ...
        Dlg_report_item_ledger_receipts dialog = Dlg_report_item_ledger_receipts.create(new javax.swing.JFrame(), true);
    ...
    private void initComponents() {
        ...
        jLabel9.setText("Date Delivered:");
...
//                disposed();
    ...
    private void search() {
        ...
        List<S1_receipt_items.to_receipt_items> datas = Srpt_item_ledger.trans_receipts(where);
        if (datas.isEmpty()) {
            Alert.set(0, "No Record Found!");
            return;
        }
        S1_receipt_items.to_receipt_items to = (S1_receipt_items.to_receipt_items) datas.get(0);
        ...
        jTextArea3.setText(to.batch_no);
        jTextField7.setText(DateType.convert_slash_datetime(to.date_added));
        jTextField8.setText(DateType.convert_slash_datetime2(to.date_delivered));
        jTextField9.setText(DateType.convert_slash_datetime2(to.date_received));
    }

    List<S1_receipt_items.to_receipt_items> sales_list = new ArrayList();

    private void init_sales() {
        String search = jTextField6.getText();

        String where = " where receipt_no like '%" + search + "%'  ";
        sales_list = S1_receipt_items.ret_data5(where);
        Object[][] obj = new Object[sales_list.size()][2];
        int i = 0;
        for (S1_receipt_items.to_receipt_items to : sales_list) {
        ...
        tr.setCallback(new TableRenderer.Callback() {
            ...
            public void ok(TableRenderer.OutputData data) {
                S1_receipt_items.to_receipt_items to = sales_list.get(data.selected_row);
                jTextField1.setText(to.receipt_no);
                jTextField2.setText(to.main_barcode);
                jTextField3.setText(to.barcode);
                jTextArea1.setText(to.description);
                ...
                jTextField5.setText(to.location);
                jTextArea2.setText(to.remarks);
                jTextArea3.setText(to.serial_no);
                jTextField7.setText(DateType.convert_slash_datetime(to.date_added));
                jTextField8.setText(DateType.convert_slash_datetime2(to.date_delivered));
                jTextField9.setText(DateType.convert_slash_datetime2(to.date_received));
            }
