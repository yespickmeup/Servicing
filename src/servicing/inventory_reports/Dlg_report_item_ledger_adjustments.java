...
import servicing.adjuster.S1_adjustments;
 ...
 * @author Guinness
 */
public class Dlg_report_item_ledger_adjustments extends javax.swing.JDialog {

    /**
     * Creates new form Dlg_report_item_ledger_adjustments
     */
...
//</editor-fold>
    ...
    private Dlg_report_item_ledger_adjustments(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        setUndecorated(true);
        initComponents();
        myInit();
    ...
    private Dlg_report_item_ledger_adjustments(java.awt.Dialog parent, boolean modal) {
        super(parent, modal);
        setUndecorated(true);
        initComponents();
        myInit();
    ...
    public Dlg_report_item_ledger_adjustments() {
        super();
        setUndecorated(true);
        initComponents();
        myInit();
    ...
    private Dlg_report_item_ledger_adjustments myRef;

    private void setThisRef(Dlg_report_item_ledger_adjustments myRef) {
        this.myRef = myRef;
    }
    private static java.util.Map<Object, Dlg_report_item_ledger_adjustments> dialogContainer = new java.util.HashMap();
    ...
    public static Dlg_report_item_ledger_adjustments create(java.awt.Window parent, boolean modal) {
    ...
    public static Dlg_report_item_ledger_adjustments create(java.awt.Window parent, java.awt.Dialog.ModalityType modalType) {

        if (parent instanceof java.awt.Frame) {

            Dlg_report_item_ledger_adjustments dialog = dialogContainer.get(parent);

            if (dialog == null) {
                dialog = new Dlg_report_item_ledger_adjustments((java.awt.Frame) parent, false);
        ...
        if (parent instanceof java.awt.Dialog) {
            ...
            if (dialog == null) {
                dialog = new Dlg_report_item_ledger_adjustments((java.awt.Dialog) parent, false);
                dialog.setModalityType(modalType);
                dialogContainer.put(parent, dialog);
                java.util.logging.Logger.getAnonymousLogger().log(Level.INFO, "instances: {0}", dialogContainer.size());
                dialog.setThisRef(dialog);
    ...
    public static void main(String args[]) {
        ...
        Dlg_report_item_ledger_adjustments dialog = Dlg_report_item_ledger_adjustments.create(new javax.swing.JFrame(), true);
...
//                disposed();
    ...
    private void search() {
        ...
        List<S1_adjustments.to_adjustments> datas = Srpt_item_ledger.trans_adjustments(where);
        if (datas.isEmpty()) {
            Alert.set(0, "No Record Found!");
            return;
        }
        S1_adjustments.to_adjustments to = (S1_adjustments.to_adjustments) datas.get(0);
    ...
    List<S1_adjustments.to_adjustments> sales_list = new ArrayList();

    private void init_sales() {
        String search = jTextField6.getText();

        String where = " where id like '" + search + "' ";
        sales_list = S1_adjustments.ret_data(where);
        Object[][] obj = new Object[sales_list.size()][2];
        int i = 0;
        for (S1_adjustments.to_adjustments to : sales_list) {
            obj[i][0] = " " + to.id;
        ...
        tr.setCallback(new TableRenderer.Callback() {
            ...
            public void ok(TableRenderer.OutputData data) {
                S1_adjustments.to_adjustments to = sales_list.get(data.selected_row);
                jTextField6.setText("" + to.id);
                jTextField2.setText(to.item_code);
                jTextField3.setText(to.barcode);
                jTextArea1.setText(to.description);
